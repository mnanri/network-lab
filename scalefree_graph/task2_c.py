...
def main():
  ...
  ax.grid(axis='x', color='gray', linestyle='--')
  ax.grid(axis='y', color='gray', linestyle='--')
  fig.savefig(f'./scalefree_graph/task2_figures/task2_mean_n{n}_10perLink_bc_hypo.png')

  with open(f'./scalefree_graph/task2_data/task2_n{n}_10perLink_{roop}samples_bc_hypo.csv', 'w') as f:
    writer = csv.writer(f)
